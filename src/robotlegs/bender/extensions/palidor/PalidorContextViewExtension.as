package robotlegs.bender.extensions.palidor
{
	...
	import robotlegs.bender.extensions.palidor.impl.StarlingContextView;
	...
	public class PalidorContextViewExtension implements IExtension
	{
		private const _uid:String = UID.create( PalidorContextViewExtension );
